    ...
    $.fn.oembed.insertCode = function(container, embedMethod, oembedData) {
        ...
        switch (embedMethod) {
          ...
          case "append":
              ...
              $('<i class="oembed-show pull-right icon-chevron-down"></i>').insertBefore(container).click(function() {
                  ...
                  $(this).parent().children().last().toggle('normal', function() {
		                 // Animation complete.
		                 
		                 $(this).find('.embed-image').show('normal');
		                 
		                 $(this).find('iframe').show('normal');
		                 
		                 if ($(this).parent().children().last().hasClass("fluid-width-video-wrapper")) {
		                 	var x = 0;
		                 }
	                 });
              });
    ...
    {yql:{xpath:"//meta", from:'html'
        , datareturn:function(results){
            ...
            if(results['og:video']) {
              ...
              var img = $('<div class="embed-image"><img src="'+results['og:image']+'"></div>');
