...
(function($) {
    $.fn.oembed = function(url, options, embedAction) {
        ...
        var shortURLList = ["0rz.tw","1link.in","1url.com","2.gp","2big.at","2tu.us","3.ly","307.to","4ms.me","4sq.com","4url.cc","6url.com","7.ly","a.gg","a.nf","aa.cx","abcurl.net",
							...
							"https:\/\/digg\.com\/[^\/]+$", "disq.us", "dld.bz", "dlvr.it", "do.my", "doiop.com", "dopen.us", "easyuri.com", "easyurl.net", "eepurl.com", "eweri.com", 
    ...
    new $.fn.oembed.OEmbedProvider("gametrailers", "video", ["gametrailers\\.com/video/.+"], "https://media.mtvnservices.com/mgid:moses:video:gametrailers.com:$2", {
    ...
    new $.fn.oembed.OEmbedProvider("colledgehumour", "video", ["collegehumor\\.com/video/.+"],"https://www.collegehumor.com/moogaloop/moogaloop.swf?clip_id=$1&use_node_id=true&fullscreen=1",
    {templateRegex:/.*video\/([^\/]+).*/ , embedtag : {width:600,height: 338}}), 
    new $.fn.oembed.OEmbedProvider("metacafe", "video", ["metacafe\\.com/watch/.+"],"https://www.metacafe.com/fplayer/$1/$2.swf",
      {templateRegex:/.*watch\/(\d+)\/(\w+)\/.*/ , embedtag : {width:400,height: 345}}), 
    new $.fn.oembed.OEmbedProvider("bambuser", "video", ["bambuser\\.com\/channel\/.*\/broadcast\/.*"],"https://static.bambuser.com/r/player.swf?vid=$1",
      {templateRegex:/.*bambuser\.com\/channel\/.*\/broadcast\/(\w+).*/ , embedtag : {width:512,height: 339 }}), 
    new $.fn.oembed.OEmbedProvider("twitvid", "video", ["twitvid\\.com/.+"],"https://www.twitvid.com/embed.php?guid=$1&autoplay=0",
      {templateRegex:/.*twitvid\.com\/(\w+).*/ , embedtag : {tag:'iframe',width:480,height: 360 }}),
      
    new $.fn.oembed.OEmbedProvider("aniboom", "video", ["aniboom\\.com/animation-video/.+"],"https://api.aniboom.com/e/$1",
      {templateRegex:/.*animation-video\/(\d+).*/ , embedtag : {width:594,height: 334}}), 
    
    new $.fn.oembed.OEmbedProvider("vzaar", "video", ["vzaar\\.com/videos/.+","vzaar.tv/.+"],"https://view.vzaar.com/$1/player?",
      {templateRegex:/.*\/(\d+).*/, embedtag : {tag:'iframe',width:576,height: 324 }}),
    new $.fn.oembed.OEmbedProvider("snotr", "video", ["snotr\\.com/video/.+"],"https://www.snotr.com/embed/$1",
      {templateRegex:/.*\/(\d+).*/, embedtag : {tag:'iframe',width:400,height: 330, nocache:1 }}), 
      
    new $.fn.oembed.OEmbedProvider("youku", "video", ["v.youku.com/v_show/id_.+"],"https://player.youku.com/player.php/sid/$1/v.swf",
      {templateRegex:/.*id_(.+)\.html.*/, embedtag : {width:480,height:400, nocache:1 }}), 
      
    new $.fn.oembed.OEmbedProvider("embedr", "video", ["embedr\\.com/playlist/.+"],"https://embedr.com/swf/slider/$1/425/520/default/false/std?",
    ...
    {yql:{xpath:"json", from:'json'
          , url: function(externalurl){return 'https://skitch.com/oembed/?format=json&url='+externalurl}
		...
		new $.fn.oembed.OEmbedProvider("flickr", "photo", ["flickr\\.com/photos/.+"], "https://secure.flickr.com/services/oembed",{callbackparameter:'jsoncallback'}),
    ...
    new $.fn.oembed.OEmbedProvider("chart.ly", "photo", ["chart\\.ly/[a-z0-9]{6,8}"],"https://chart.ly/uploads/large_$1.png?",
    ...
    new $.fn.oembed.OEmbedProvider("twitgoo.com", "photo", ["twitgoo\\.com/.+"],"https://twitgoo.com/show/thumb/$1?",
      {templateRegex:/.*com\/([^\/]+).*/ , embedtag : {tag:'img'}}), 
    ...
    new $.fn.oembed.OEmbedProvider("wikipedia", "rich", ["wikipedia.org/wiki/.+"], "https://$1.wikipedia.org/w/api.php?action=parse&page=$2&format=json&section=0&callback=?",{
      ...
      templateData : function(data){if(!data.parse)return false;
          var text = data.parse['text']['*'].replace('href="/wiki','href="https://en.wikipedia.org/wiki');
    ...
    new $.fn.oembed.OEmbedProvider("imdb", "rich", ["imdb.com/title/.+"], "https://www.imdbapi.com/?i=$1&callback=?",
      ...
      templateData : function(data){if(!data.Title)return false;
          return  '<div id="content"><h3><a class="nav-link" href="https://imdb.com/title/'+data.ID+'/">'+data.Title+'</a> ('+data.Year+')</h3><p>Starring: '+data.Actors+'</p><div id="photo-wrap" style="margin: auto;width:600px;height:450px;"><img class="photo" id="photo-display" src="'+data.Poster+'" alt="'+data.Title+'"></div>  <div id="view-photo-caption">'+data.Plot+'</div></div>';
        }
      }),
    new $.fn.oembed.OEmbedProvider("livejournal", "rich", ["livejournal.com/"], "https://ljpic.seacrow.com/json/$2$4?jsonp=?"
    ,{templateRegex:/(https:\/\/(((?!users).)+)\.livejournal\.com|.*users\.livejournal\.com\/([^\/]+)).*/,
    ...
    new $.fn.oembed.OEmbedProvider("jsfiddle", "rich", ["jsfiddle.net/[^/]+/?"],"https://jsfiddle.net/$1/embedded/?",
    ...
    ,{templateRegex:/.*facebook.com\/(people\/[^\/]+\/(\d+).*|([^\/]+$))/,
      templateData : function(data){ if(!data.id)return false;
          var out =  '<div class="oembedall-facebook1"><div class="oembedall-facebook2"><a href="https://www.facebook.com/">facebook</a> <a href="'+data.link+'">'+data.name+'</a></div><div class="oembedall-facebookBody"><div>';
    ...
    {yql:{xpath:"//meta", from:'html'
        , datareturn:function(results){
            ...
            var code = $('<div class="well"/>');
            if(results['og:title']) code.append('<p class="lead">'+results['og:title']+'</p>');
            if(results['og:description'])
             code.append('<small>' + results['og:description'] + '</small>');
            else if(results['description'])
              code.append('<small>' + results['description']+'</small>');
            if(results['og:video']) {
              ...
              var img = $('<div><img src="'+results['og:image']+'"></div>');
